...
public class JavaStreams {
	...
	listaProdutos.stream()
		...
		// Interface Comparator - ordenar o preço em ordem crescente de acordo com a
		// implemetação da classe OrdenaProdutoPorPreco
		.sorted((p1, p2) -> p1.getPreco().compareTo(p2.getPreco()))

		// Interface Function - aplicar uma dada função (toUpperCase) aos elementos
		// dessa stream

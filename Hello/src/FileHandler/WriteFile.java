...
public class WriteFile {
	...
	/*
	 * Escreve fluxos de caracteres (string) em arquivo. Maneira mais simples até
	 * então. Indicado para poucas operações de escrita.
	 */
	...
	/*
	 * Grava o texto em uma stream de saída, usando mecanismo de buffer para
	 * gravação mais eficiente de caracteres.
	 */
